 ...
 * https://github.com/ekillaby/simple-http-client
 * 
 */
class SimpleHTTPClient {
    ...
    public function disableSslVerify($ch){
    ...
    //extended by 0x4164
    public function post($url, $requestBody = null, $requestHeader = null){
        return $this->makeRequest($url, 
            "POST", 
            $requestBody, $requestHeader);
    }

    public function get($url, $requestBody = null, $requestHeader = null){
        return $this->makeRequest($url, 
            "GET", 
            $requestBody, $requestHeader);
    }

    public function setVerifySSL($s){
        $this->verifySSL = $s ? true : false;
